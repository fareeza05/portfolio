...
import { IconHome, IconUser, IconCode, IconBriefcase2, IconBulb, IconMailSpark, IconDownload } from '@tabler/icons-react';
        ...
        <div className='grid grid-cols-1 sm:grid-cols-12 mt-[100px]'>
            <div className='col-span-7 place-self-center text-center sm:text-left'>
                ...
                <div className='flex items-center'>
                    <button className='px-6 py-2.5 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-400 to-pink-400 hover:bg-slate-800 text-white'>Let's Connect!</button>
                    ...
                    <span className='flex items-center bg-[#121212] hover:bg-slate-100 hover:text-black rounded-full px-5 py-2'>
                        Resume
            ...
            <div className='col-span-5 place-self-center mt-4 lg:mt-0'>
                <div className='rounded-full bg-[#181818]  w-[250px] h-[250px] lg:w-[500px] lg:h-[500px] relative mt-5'>
